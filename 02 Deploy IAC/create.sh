...
then
  ...
  #aws cloudformation update-stack --stack-name $1 --template-body file://$2 --capabilities "CAPABILITY_IAM" "CAPABILITY_NAMED_IAM" --region=us-west-2 --parameters file://CFLesson3/network-parameters.json 
elif [ $? = 1 ]
then 
